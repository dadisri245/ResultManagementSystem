...
class Register:
    def __init__(self,root):
        ...
        btn_login=Button(self.root,text="Sign In",command=self.login_window,font=("times new roman",20),bd=0,cursor="hand2",bg="green").place(x=250,y=460,width=130)
    ...
    def register_data(self):
        if self.txt_fname.get()=="" or self.txt_email.get()=="" or self.cmb_quest.get()=="Select" or self.txt_answer.get()=="" or self.txt_contact.get()=="" or self.txt_password.get()=="" or self.txt_cpassword.get()=="":
